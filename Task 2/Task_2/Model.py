...
# fill missing values with most common falue
...
#(feature1, feature2, Class1, class2)
def Training(X1, X2, Y1, Y2, eta, m, b1, MSE_threshold):
        #choosing classes
        global c1
        global c2
...
#Training(1, 2, 1, 2, 0.01, 50, 0, 0.5)
